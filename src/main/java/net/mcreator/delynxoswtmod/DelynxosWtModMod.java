package net.mcreator.delynxoswtmod;
...
import net.mcreator.delynxoswtmod.init.DelynxosWtModModItems;
...
@Mod("delynxos_wt_mod")
public class DelynxosWtModMod {
	public static final Logger LOGGER = LogManager.getLogger(DelynxosWtModMod.class);
	public static final String MODID = "delynxos_wt_mod";

	public DelynxosWtModMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);

		DelynxosWtModModItems.register(modEventBus);

		DelynxosWtModModVariables.ATTACHMENT_TYPES.register(modEventBus);
